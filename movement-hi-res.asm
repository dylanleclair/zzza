...
GETIN = $FFE4                   ; KERNAL routine to get keyboard input
    ...
    dc.w 12345 
    dc.b $9e, "4336", 0         ; remember to change whenever character set changes
stubend
    dc.w 0
...
;----------------------------------------------------------------------------------
;   Handles shifting the framebuffer with EVA in the center
;----------------------------------------------------------------------------------
;----------------------------------------------------------------------------------
;----------------------------------------------------------------------------------
;----------------------------------------------------------------------------------
...
; !!!!!! TODO:  ROTATE DIRECTLY ON THE MEMORY !!!!!!!!
; !!!!!! TODO:  ROTATE DIRECTLY ON THE MEMORY !!!!!!!!
; !!!!!! TODO:  ROTATE DIRECTLY ON THE MEMORY !!!!!!!!
; !!!!!! TODO:  ROTATE DIRECTLY ON THE MEMORY !!!!!!!!
; !!!!!! TODO:  ROTATE DIRECTLY ON THE MEMORY !!!!!!!!
...
mask_loop_test
    ...
    inc INNER_LOOP_COUNT
    lda INNER_LOOP_COUNT
    cmp #8
    bne mask_loop

    rts

; must multiple both by 8 ???